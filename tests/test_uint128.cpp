...
TEST(UInt128Test, DifferentConstructors) {
    libnet::uint128_t data = 1024;
    
    libnet::uint128_t udata_128 = __uint128_t(1024);
    libnet::uint128_t udata_64 = uint64_t(1024);
    libnet::uint128_t udata_32 = uint32_t(1024);
    libnet::uint128_t udata_16 = uint16_t(1024);

    libnet::uint128_t sdata_128 = __int128_t(1024);
    libnet::uint128_t sdata_64 = int64_t(1024);
    libnet::uint128_t sdata_32 = int32_t(1024);
    libnet::uint128_t sdata_16 = int16_t(1024);
...
TEST(UInt128Test, HeapTest) {
    libnet::uint128_t* data = new libnet::uint128_t(1024);
    EXPECT_EQ(*data, 1024);

    delete data;
    data = nullptr;

    libnet::uint128_t* _dt = new libnet::uint128_t[32];
